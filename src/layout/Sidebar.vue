<template>
  <div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
      ...
      <div class="app-branding">
        <RouterLink class="app-logo" to="/"><img class="logo-icon me-2" :src="applogo" alt="logo"><span class="logo-text">PORTAL</span></RouterLink>
      ...
      <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
          ...
          <li class="nav-item">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <RouterLink class="nav-link" :class="{ active: $route.path === '/docs' }" to="/docs">
						        <span class="nav-icon">
  ...
  <path fill-rule="evenodd" d="M13.81 4H2.19a1 1 0 0 0-.996 1.09l.637 7a1 1 0 0 0 .995.91h10.348a1 1 0 0 0 .995-.91l.637-7A1 1 0 0 0 13.81 4zM2.19 3A2 2 0 0 0 .198 5.181l.637 7A2 2 0 0 0 2.826 14h10.348a2 2 0 0 0 1.991-1.819l.637-7A2 2 0 0 0 13.81 3H2.19z"/>
          ...
          <li class="nav-item">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <RouterLink class="nav-link" :class="{ active: $route.path === '/products' }" to="/products">
						        <span class="nav-icon">
...
<script>
import applogo from "../assets/theme_assets/images/app-logo.svg";
export default {
